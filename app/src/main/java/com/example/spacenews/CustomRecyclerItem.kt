...
class CustomRecyclerItem(context: Context?, id :Int) : ConstraintLayout(context!!)
{
    ...
    init {
        ...
        val view = inflater.inflate(R.layout.custom_item, this, true)
        photo = view.findViewById(R.id.itemImage)
        title = view.findViewById(R.id.itemTitle)
        date = view.findViewById(R.id.dateItem)
        site = view.findViewById(R.id.siteItem)
        star = view.findViewById(R.id.itemStar)
        ...
        val request = StringRequest(
            Request.Method.GET, "https://api.spaceflightnewsapi.net/v3/articles/$id",
            {
                ...
                date.append(message.publishedAt.substring(0,10))
